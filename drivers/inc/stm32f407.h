...
//base addr of memory elements
#define FLASH_BASEADDR 0x08000000U
#define SRAM1_BASEADDR 0x20000000U
#define SRAM           SRAM1_BASEADDR
#define SRAM2_BASEADDR (SRAM1_BASEADDR+(112*1024))U
...
//base addr of GPIO peripherals ON AHB1 bus

#define GPIOA_BASEADDR      (AHB1PERIPH_BASEADDR+0x0000)
#define GPIOB_BASEADDR      (AHB1PERIPH_BASEADDR+0x0040)
#define GPIOC_BASEADDR      (AHB1PERIPH_BASEADDR+0x0080)
#define GPIOD_BASEADDR      (AHB1PERIPH_BASEADDR+0x00C0)
...
//converting the port to portcode
...
//GPIO Peripheral structur definition
...
typedef struct
{
	...
	__vo uint32_t RTSR;   /*!< RISING TRIGGER SEL REGISTER					     Address offset: 0x08 */
	__vo uint32_t FTSR;   /*!< FALLING TRIGGER SEL REGISTER				Address offset: 0x0C */
...
#define GPIOF_PCLK_DI() (RCC->APB1ENR &= ~(1<<5))
#define GPIOG_PCLK_DI() (RCC->APB1ENR &= ~(1<<6))
#define GPIOH_PCLK_DI() (RCC->APB1ENR &= ~(1<<7))
#define GPIOI_PCLK_DI() (RCC->APB1ENR &= ~(1<<8))
